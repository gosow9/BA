...
\mbox{}
\vfill
\noindent This document is created with {\LaTeX} and Ti\textit{k}Z

\smallskip
\noindent The layout is based on Prof. Dr. Andreas Müller's \textit{Partial Differential Equations} lecture notes

\smallskip
\noindent If you are interested in one of the tikz images contact \href{mailto:cedric.renda@hotmail.com}{cedric.renda@hotmail.com}
...
\input{3-development/3-development.tex}
\input{4-results/4-results.tex}
\input{5-summary/5-summary.tex}
