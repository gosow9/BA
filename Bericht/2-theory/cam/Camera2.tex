...
\begin{tikzpicture}[x={(0.866cm,-0.5cm)}, y={(0.866cm,0.5cm)}, z={(0cm,1cm)}, scale=1.0,
	...
	\node[canvas is zy plane at x=0,above right,opacity=0.7] (foto) at (0,-5.2,-4) {\includegraphics[width=0.8\textwidth,angle=90]{slice.png}};
	\node[canvas is zy plane at x=0,above right,opacity=0.7] (foto) at (10,-0.7,-4) {\includegraphics[width=0.4\textwidth,angle=270]{slice.png}};

\node[canvas is zy plane at x=0,above right,opacity=0.2] (foto) at (2.5,-0.7,-4) {\includegraphics[width=0.4\textwidth,angle=90]{slice.png}};
   ...
   % \draw[wave=blue, opacity=0.7, variable=\x, samples at={-2,-1.75,...,0}]
	...
	\filldraw[polaroid] (12,-2,-1.5) -- (12,-2,1.5) node[opacity=1,above, sloped, midway]{Camera Sesnor} -- (12,2,1.5) -- (12,2,-1.5) -- (12,-2,-1.5);
