...
\begin{document}
	...
	my vectors/.style={green!50!black, {latex[scale=.75]}-{latex[scale=.75]}},
	...
	\path [description] (0,4,0) [out=-95, in=95] to (-.75,4,.25) node {center\\point} (0,6.5,0) [out=-95, in=95] to (-.75,6.5,.25) node {optical\\axis};
	\end{tikzpicture}
\end{document}