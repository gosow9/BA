...
\begin{document}
		\begin{tikzpicture}[scale=1,every node/.style={minimum size=1cm},>=latex]
		%% some definitions
...
%		\draw[-stealth,thick] (0,0,0) -- (4*1.80,0,0);
%		\draw[-stealth] (0,0,0) -- (0,4*1.30,0);
%		\draw[-stealth] (0,0,0) -- (0,0,4*1.30);
		\end{tikzpicture}
