...
def full_dist_model_x(k1, k2, k3, k4, k5, k6, s1, s2, x, y, r):
    r_dist = r_dist_model(k1, k2, k3, k4, k5, k6, x, r)
    return r_dist + s1*r**2 + s2*r**4
    
def full_dist_model_y(k1, k2, k3, k4, k5, k6, s2, s4, x, y, r):
...
ax.set_title(r'6 radial, 4 prism')
...
for i in range(n):
    ...
    dist_x = fx*full_dist_model_x(k1, k2, k3, k4, k5, k6, s1, s2, x/fx, y/fx, new_r)
    dist_y = fy*full_dist_model_y(k1, k2, k3, k4, k5, k6, s3, s4, x/fx, y/fy, new_r)
