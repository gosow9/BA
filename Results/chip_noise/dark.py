...
s = ax1[0].imshow(gray, cmap='gray')
ax1[0].set_axis_off()
    
ax1[1].set_aspect(7000)

cb = plt.colorbar(s, orientation='horizontal', ax=ax1[1], pad=0.01)
cb.set_label('Intensity')
cb.set_ticks([0, 63, 127, 191,255])

ax1[1].plot(np.arange(0, 256, 1), h, color='tab:blue')
ax1[1].set_xlim([0,255])
ax1[1].set_xticks([0, 63, 127, 191, 255])
ax1[1].xaxis.set_major_formatter(NullFormatter())
ax1[1].set_yticks([0, 0.01, 0.02 , 0.03])
ax1[1].set_ylim([0, 0.03])
ax1[1].grid(True)

fig1.savefig('dark_hist.pdf')
