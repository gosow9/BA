...
# load results
std_c = np.loadtxt('params_3k/std.txt')
rpe_c = np.loadtxt('params_3k/rpe.txt')
sharp_c = np.loadtxt('params_3k/sharp.txt')
fx_c = np.loadtxt('params_3k/fx.txt')
fy_c = np.loadtxt('params_3k/fy.txt')
cx_c = np.loadtxt('params_3k/cx.txt')
cy_c = np.loadtxt('params_3k/cy.txt')s
k1_c = np.loadtxt('params_3k/k1.txt')
k2_c = np.loadtxt('params_3k/k2.txt')
k3_c = np.loadtxt('params_3k/k3.txt')
k4_c = np.loadtxt('params_3k/k4.txt')
k5_c = np.loadtxt('params_3k/k5.txt')
k6_c = np.loadtxt('params_3k/k6.txt')
p1_c = np.loadtxt('params_3k/p1.txt')
p2_c = np.loadtxt('params_3k/p2.txt')
s1_c = np.loadtxt('params_3k/s1.txt')
s2_c = np.loadtxt('params_3k/s2.txt')
s3_c = np.loadtxt('params_3k/s3.txt')
s4_c = np.loadtxt('params_3k/s4.txt')
...
# compute model
dst_r_m = f*ptlens(np.sqrt((x/f)**2+(y/f)**2))
