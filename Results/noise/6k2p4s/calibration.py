...
for sigma in std:
    ...
    # save params
    with open('params/complete/params_{:}.txt'.format(sigma), 'w') as f:
...
np.savetxt('params/cx.txt', cx)
np.savetxt('params/cy.txt', cy)
np.savetxt('params/k1.txt', k1)
np.savetxt('params/k2.txt', k2)
np.savetxt('params/k3.txt', k3)
np.savetxt('params/k4.txt', k4)
np.savetxt('params/k5.txt', k5)
np.savetxt('params/k6.txt', k6)
np.savetxt('params/p1.txt', p1)
np.savetxt('params/p2.txt', p2)
np.savetxt('params/s1.txt', s1)
np.savetxt('params/s2.txt', s2)
np.savetxt('params/s3.txt', s3)
np.savetxt('params/s4.txt', s4)
